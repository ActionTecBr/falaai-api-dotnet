...
namespace FalaAI.Api.Test.Api
{
    ...
    public class SpeechApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test an instance of SpeechApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' SpeechApi
            //Assert.IsType<SpeechApi>(instance);
        }

        /// <summary>
        /// Test CreateTranscriptionV1AudioTranscriptionsPost
        /// </summary>
        [Fact]
        public void CreateTranscriptionV1AudioTranscriptionsPostTest()
        {
            ...
            //var response = instance.CreateTranscriptionV1AudioTranscriptionsPost(file, model, language, clientReferenceId);
