...
namespace FalaAI.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuditoriaRiscoV2Response")]
    public partial class AuditoriaRiscoV2Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditoriaRiscoV2Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditoriaRiscoV2Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditoriaRiscoV2Response" /> class.
        /// </summary>
        /// <param name="response">Public response V2 â€” always returned (required).</param>
        public AuditoriaRiscoV2Response(AuditoriaRiscoV2 response = default)
        {
            // to ensure "response" is required (not null)
            if (response == null)
            {
                throw new ArgumentNullException("response is a required property for AuditoriaRiscoV2Response and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Public response V2 â€” always returned</value>
        [DataMember(Name = "response", IsRequired = true, EmitDefaultValue = true)]
        public AuditoriaRiscoV2 Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditoriaRiscoV2Response {\n");
