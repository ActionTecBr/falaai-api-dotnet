...
namespace FalaAI.Api.Model
{
    ...
    /// UsageLogResponse
    /// </summary>
    [DataContract(Name = "UsageLogResponse")]
    public partial class UsageLogResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsageLogResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UsageLogResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsageLogResponse" /> class.
        /// </summary>
        ...
        public UsageLogResponse(List<UsageLogItem> data = default, int page = default, int limit = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for UsageLogResponse and cannot be null");
            }
            this.Data = data;
            this.Page = page;
            this.Limit = limit;
        ...
        public List<UsageLogItem> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UsageLogResponse {\n");
