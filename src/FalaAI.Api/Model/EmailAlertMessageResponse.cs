...
namespace FalaAI.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmailAlertMessageResponse")]
    public partial class EmailAlertMessageResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailAlertMessageResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailAlertMessageResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailAlertMessageResponse" /> class.
        /// </summary>
        /// <param name="message">Operation result message (required).</param>
        public EmailAlertMessageResponse(string message = default)
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for EmailAlertMessageResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Operation result message</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailAlertMessageResponse {\n");
