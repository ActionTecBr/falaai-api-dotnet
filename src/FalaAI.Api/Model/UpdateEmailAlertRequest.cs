...
namespace FalaAI.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateEmailAlertRequest")]
    public partial class UpdateEmailAlertRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEmailAlertRequest" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="email">email.</param>
        /// <param name="events">events.</param>
        /// <param name="active">active.</param>
        public UpdateEmailAlertRequest(string name = default, string email = default, List<EmailEvent> events = default, bool? active = default)
        {
            this.Name = name;
            this.Email = email;
            this.Events = events;
