...
namespace FalaAI.Api.Model
{
    ...
    public partial class WebhookListResponse : IValidatableObject
    {
        ...
        public WebhookListResponse(List<WebhookItem> data = default, int page = default, int limit = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for WebhookListResponse and cannot be null");
            }
            this.Data = data;
            this.Page = page;
            this.Limit = limit;
        ...
        public List<WebhookItem> Data { get; set; }
