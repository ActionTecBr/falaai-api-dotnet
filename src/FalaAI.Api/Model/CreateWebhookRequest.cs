...
namespace FalaAI.Api.Model
{
    ...
    public partial class CreateWebhookRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CreateWebhookRequest" /> class.
        /// </summary>
        /// <param name="name">Nome identificador do webhook (required).</param>
        /// <param name="url">URL HTTPS que recebera POST com HMAC FalaAI-Signature (required).</param>
        /// <param name="events">Eventos subscritos (10 alertas) (required).</param>
        /// <param name="retryEnabled">Retry exponencial 5 tentativas quando true (false&#x3D;1 tentativa) (default to false).</param>
        public CreateWebhookRequest(string name = default, string url = default, List<WebhookEvent> events = default, bool retryEnabled = false)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateWebhookRequest and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>Nome identificador do webhook</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>URL HTTPS que recebera POST com HMAC FalaAI-Signature</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Eventos subscritos (10 alertas)</value>
        /*
        <example>[credits.low, credits.exhausted, payment.failed]</example>
        */
        ...
        /// </summary>
        /// <value>Retry exponencial 5 tentativas quando true (false&#x3D;1 tentativa)</value>
        /*
