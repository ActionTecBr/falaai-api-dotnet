...
namespace FalaAI.Api.Model
{
    ...
    /// TranscriptionUsage
    /// </summary>
    [DataContract(Name = "TranscriptionUsage")]
    public partial class TranscriptionUsage : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranscriptionUsage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranscriptionUsage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranscriptionUsage" /> class.
        /// </summary>
        /// <param name="audioSeconds">Actual audio duration processed in seconds (required).</param>
        /// <param name="creditsConsumed">Number of credits consumed in this request (required).</param>
        /// <param name="processingMs">Total processing time in milliseconds (required).</param>
        public TranscriptionUsage(decimal audioSeconds = default, int creditsConsumed = default, int processingMs = default)
        {
        ...
        /// </summary>
        /// <value>Actual audio duration processed in seconds</value>
        /*
        <example>151.04</example>
        */
        [DataMember(Name = "audio_seconds", IsRequired = true, EmitDefaultValue = true)]
        public decimal AudioSeconds { get; set; }

        /// <summary>
        /// Number of credits consumed in this request
        /// </summary>
        /// <value>Number of credits consumed in this request</value>
        /*
        <example>65</example>
        */
        ...
        /// </summary>
        /// <value>Total processing time in milliseconds</value>
        /*
        <example>15156</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranscriptionUsage {\n");
            sb.Append("  AudioSeconds: ").Append(AudioSeconds).Append("\n");
